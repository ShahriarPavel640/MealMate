...
import { Loader2, Package, Calendar, Wallet, CheckCircle, Clock, MapPin, Award } from "lucide-react";
...
const DeliveryHistoryPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      setLoading(true);
      try {
        const res = await axiosInstance.get<DeliveryHistoryResponse>(`/rider/orders/history?page=${currentPage}&limit=10`);
