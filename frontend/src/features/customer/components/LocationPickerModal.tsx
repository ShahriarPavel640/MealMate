...
interface LocationPickerModalProps {
  ...
  initialLocation?: { lat: number | null | string; lng: number | null | string } | null;
}
...
function LocationPickerModal({
  ...
  const getSanitizedLocation = (): Coords => {
    if (initialLocation && initialLocation.lat != null && initialLocation.lng != null) {
      const lat = typeof initialLocation.lat === "number" ? initialLocation.lat : parseFloat(initialLocation.lat as string);
      const lng = typeof initialLocation.lng === "number" ? initialLocation.lng : parseFloat(initialLocation.lng as string);
  ...
  const [selected, setSelected] = useState<Coords>(getSanitizedLocation);
