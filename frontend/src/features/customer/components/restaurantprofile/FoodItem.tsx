...
import { MenuItem, CartItem } from "@/types/models";
...
export function FoodItem({ item, onAddToCart, cartItems, restaurant_is_open }: FoodItemProps): React.JSX.Element {
  const isInCart = cartItems.some(
    (cartItem) => cartItem.menu_item_id === item.menu_item_id
  );

  const displayImage = item.menu_item_image_url || item.image || "";
