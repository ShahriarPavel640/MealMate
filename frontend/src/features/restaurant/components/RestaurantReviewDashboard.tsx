...
const RestaurantReviewDashboard: React.FC = () => {
    ...
    const fetchReviews = async () => {
      ...
      try {
        const res = await axiosInstance.get(
          `/restaurant/reviews?page=${currentPage}&limit=${itemsPerPage}`
        );
  ...
  return (
    <div
      className="p-6 bg-gray-900 min-h-screen text-white space-y-6"
      ref={topRef}
    >
      <div>
