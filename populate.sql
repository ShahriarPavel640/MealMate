...
(1, 'Black, Davis and Simon', 'hashed_password', '489-159-3776', 'sandra22@hotmail.com', 1, 3.32, 'burger-deluxe.jpg', 'American', 'Best burgers in town'),
(2, 'Atkinson, Price and Williams', 'hashed_password', '598-533-6698', 'randallmcintyre@gutierrez-carroll.com', 2, 3.77, 'caesar-salad.jpg', 'Healthy', 'Fresh salads and wraps'),
(3, 'Fisher PLC', 'hashed_password', '591-386-3262', 'millerdiana@yahoo.com', 3, 4.34, 'chocolate-lava-cake.jpg', 'Dessert', 'Sweet treats for everyone'),
(4, 'Robles LLC', 'hashed_password', '660-697-9159', 'suzanne68@navarro.biz', 4, 3.48, 'pasta-carbonara.jpg', 'Italian', 'Authentic pasta and pizza'),
(5, 'Cook LLC', 'hashed_password', '639-438-0388', 'kevin36@robinson.com', 5, 4.92, 'pizza-margherita.jpg', 'Pizza', 'Wood fired oven pizzas');
...
(1, 1, 'simple', 'cat_simple.jpg'),
(2, 2, 'money', 'cat_money.jpg'),
(3, 3, 'lay', 'cat_lay.jpg'),
(4, 4, 'travel', 'cat_travel.jpg'),
(5, 5, 'even', 'cat_even.jpg');

-- Menu Items
INSERT INTO menu_items (menu_item_id, category_id, name, description, price, is_available) VALUES 
(1, 1, 'across', 'Partner from fly movie media receive.', 32.15, true),
(2, 2, 'anyone', 'Right seat manage poor late.', 35.15, true),
(3, 3, 'magazine', 'Great late think themselves final two.', 34.62, true),
(4, 4, 'or', 'Shoulder behavior yard kid meeting control operation.', 30.42, true),
(5, 5, 'know', 'Expect want tree challenge eight goal.', 12.65, true);
