...
export interface RiderProfileUpdateData {
  name?: string;
  phone_number?: string;
  phone?: string;
  vehicle_type?: string;
...
export const updateRiderProfile = async (riderId: number, data: RiderProfileUpdateData) => {
...
export const updateRiderAvailability = async (riderId: number, isAvailable: unknown) => {
