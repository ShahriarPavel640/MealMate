  ...
  paths: {
    ...
    '/api/restaurant/login': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/RestaurantLogin' } },
          },
        },
    ...
    '/api/restaurant/edit_profile': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'multipart/form-data': { schema: { $ref: '#/components/schemas/EditProfile' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
    ...
    '/api/restaurant/add_menu': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'multipart/form-data': { schema: { $ref: '#/components/schemas/AddMenu' } } },
        },
        responses: { 201: { description: 'Success' } },
      },
    },
    '/api/restaurant/edit_menu/{menu_item_id}': {
      put: {
        ...
        security: [{ cookieAuth: [] }],
        parameters: [
          { name: 'menu_item_id', in: 'path', required: true, schema: { type: 'integer' } },
        ],
        requestBody: {
          required: true,
          content: { 'multipart/form-data': { schema: { $ref: '#/components/schemas/AddMenu' } } },
    ...
    '/api/restaurant/change_availablity/{menu_item_id}': {
      put: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/ChangeAvailability' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
    ...
    '/api/restaurant/restaurants/{id}/categories': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CreateMenuCategory' } },
          },
        },
        responses: { 201: { description: 'Success' } },
      },
    ...
    '/api/restaurant/categories/{id}/items': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CreateMenuItem' } },
          },
        },
        responses: { 201: { description: 'Success' } },
      },
    ...
    '/api/restaurant/menu-items/{id}': {
      put: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/UpdateMenuItem' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
    ...
    '/api/restaurant/today_stat': {
      get: {
        tags: ['Restaurant - Order'],
        summary: "Get today's order stats",
        security: [{ cookieAuth: [] }],
        responses: { 200: { description: 'Success' } },
      },
    },
    ...
    '/api/restaurant/category_wise_sell': {
      get: {
        tags: ['Restaurant - Stats'],
        summary: 'Get category wise sales',
        security: [{ cookieAuth: [] }],
        responses: { 200: { description: 'Success' } },
      },
    },
    '/api/restaurant/last_two_week_revenue': {
      get: {
        tags: ['Restaurant - Stats'],
        summary: 'Get last 2 weeks revenue',
        security: [{ cookieAuth: [] }],
        responses: { 200: { description: 'Success' } },
      },
    },
    '/api/restaurant/last_two_week_order_count': {
      get: {
        tags: ['Restaurant - Stats'],
        summary: 'Get last 2 weeks order count',
        security: [{ cookieAuth: [] }],
        responses: { 200: { description: 'Success' } },
      },
    },
    '/api/restaurant/last_two_week_new_customer': {
      get: {
        tags: ['Restaurant - Stats'],
        summary: 'Get last 2 weeks new customers',
        security: [{ cookieAuth: [] }],
        responses: { 200: { description: 'Success' } },
      },
    },
