...
const swaggerDocument = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'Interactive API documentation for MealMate Customer, Restaurant, and Rider modules.',
  },
  servers: [
    {
  ...
  components: {
    securitySchemes: {
      cookieAuth: {
        ...
        in: 'cookie',
        name: 'jwt',
        description: 'HttpOnly JWT Cookie. Log in via any /login endpoint to automatically set this cookie.',
      },
    },
    schemas: {
