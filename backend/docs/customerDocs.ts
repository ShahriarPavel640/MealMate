const customerDocs = {
  ...
  paths: {
    ...
    '/api/customer/register': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CustomerSignup' } },
          },
        },
    ...
    '/api/customer/login': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CustomerLogin' } },
          },
        },
    ...
    '/api/customer/is-verify': {
      get: {
        tags: ['Customer - Auth'],
        summary: 'Verify customer session',
        security: [{ cookieAuth: [] }],
    ...
    '/api/customer/change_password': {
      put: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CustomerChangePassword' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
    ...
    '/api/customer/update_profile': {
      put: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CustomerUpdateProfile' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
    ...
    '/api/customer/add_cart': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/AddToCart' } } },
        },
        responses: { 200: { description: 'Success' } },
      },
    },
    '/api/customer/cart/{cart_item_id}': {
      delete: {
        ...
        security: [{ cookieAuth: [] }],
        parameters: [
          { name: 'cart_item_id', in: 'path', required: true, schema: { type: 'integer' } },
        ],
        responses: { 200: { description: 'Success' } },
      },
    },
    ...
    '/api/customer/payment/initiate': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/InitiatePayment' } },
          },
        },
