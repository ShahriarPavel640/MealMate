  ...
  paths: {
    ...
    '/api/rider/signup': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/RiderSignup' } } },
        },
    ...
    '/api/rider/login': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/RiderLogin' } } },
        },
    ...
    '/api/rider/data/profile': {
      ...
      put: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/RiderUpdateProfile' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
    ...
    '/api/rider/data/availability': {
      put: {
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/RiderUpdateAvailability' },
            },
          },
        },
        responses: { 200: { description: 'Success' } },
    ...
    '/api/rider/data/orders/{orderId}/status': {
      put: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/RiderUpdateOrderStatus' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
