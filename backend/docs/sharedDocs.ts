    ...
    '/api/customer/review/restaurant': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/SubmitRestaurantReview' } },
          },
        },
    ...
    '/api/customer/review/rider': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/SubmitRiderReview' } },
          },
        },
        responses: { 201: { description: 'Success' } },
      },
    ...
    '/api/ai/generate-description': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/AIGenerateDescription' } },
          },
        },
        responses: { 200: { description: 'Success' } },
      },
