...
export const editProfile = async (req, res, next) => {
  try {
    ...
    if (req.body.operating_hours) {
      try {
        operatingHours = typeof req.body.operating_hours === "string" 
...
export const add_menu = async (req, res, next) => {
  try {
    const id = req.user.id;
    let imageUrl = null;
...
export const edit_menu = async (req, res, next) => {
  try {
    const restaurantId = req.user.id;
...
export const change_menu_availability = async (req, res, next) => {
  try {
    const restaurantId = req.user.id;
    const menuItemId = req.params.menu_item_id;
...
export const delete_menu = async (req, res, next) => {
  try {
    const restaurantId = req.user.id;
    const menuItemId = req.params.menu_item_id;
...
export const get_menu = async (req, res, next) => {
  try {
    const restaurantId = req.user.id;
...
export const get_menu_categories = async (req, res, next) => {
  try {
    const restaurantId = req.user.id;
